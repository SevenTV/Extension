...
const showLowTrustUser = useConfig<boolean>("highlights.basic.low_trust_user");
...
function onChatMessage(msg: ChatMessage, msgData: Twitch.AnyMessage, shouldRender = true) {
	...
	if (msgData.type === MessageType.RESTRICTED_LOW_TRUST_USER_MESSAGE && showLowTrustUser.value) {
