...
<script lang="ts">
import { HighlightDef, IgnoreDef } from "@/composable/chat/useChatHighlights";
import { declareConfig, useConfig } from "@/composable/useSettings";
import SettingsConfigIgnoresWrapper from "@/app/settings/SettingsConfigIgnoresWrapper.vue";
...
export const config = [
	...
	declareConfig<Map<string, IgnoreDef>>("chat.ignores", "CUSTOM", {
		path: ["Chat", "Ignores"],
		custom: {
			component: markRaw(SettingsConfigIgnoresWrapper),
			gridMode: "new-row",
		},
		label: "Ignores",
