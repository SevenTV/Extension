...
export const config = [
	...
	declareConfig("general.hide_channel_leaderboard", "TOGGLE", {
		path: ["General", ""],
		label: "Hide Channel Leaderboard",
		hint: "If checked, the channel leaderboard at the top of chat will be hidden",
		defaultValue: false,
	}),
	declareConfig("general.hide_buttons_below_chatbox", "TOGGLE", {
		path: ["General", ""],
