...
export enum MessageType {
	...
	SHOUTOUT = 47,
	ANNOUNCEMENT_MESSAGE = 48,
	CHARITY_DONATION = 49,
	MESSAGE_ID_UPDATE = 50,
	VIEWER_MILESTONE = 51,
	GIGANTIFIED_EMOTE = 52,
	ONE_TAP_BREAKPOINT_ACHIEVED = 53,
	ONE_TAP_STREAK_EXPIRED = 54,
	ONE_TAP_STREAK_STARTED = 55,
	SUBSIDIZED_SUB = 56,
	SUBSIDIZED_SUB_MYSTERY_GIFT = 57,
	SOCIAL_SHARING_BADGE = 58,
	GIFT_SUB_BASE_MATCH = 59,
	GIFT_SUB_BONUS_MATCH_SUMMARY = 60,
	GIFT_SUB_BONUS_MATCH_INDIVIDUAL = 61,
